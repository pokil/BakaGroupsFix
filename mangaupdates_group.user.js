...
var group = {
	...
	"5474":"http://bi3n3nstich.tumblr.com/tagged/scanlation",
...
var ircGroup = {
	...
	"2155":"irc.irchighway.net/viscans",
	...
	"3313":"irc.irchighway.net/bakanahaven",
	...
	"4389":"irc.irchighway.net/Lively",
	...
	"5925":"irc.rizon.net/onmyodo",
	"5928":"irc.irchighway.net/TSP",
	"5935":"irc.rizon.net/yurihut",
	"5949":"irc.irchighway.net/banditsofthedeep",
	...
	for (var i = 0; i < padLen; i++){
		...
		if (readImg.length > 0) {
			...
			if(readImg[0].src.indexOf('images/listicons/type0.gif') >= 0){
				pad[i].style.backgroundColor = color; 
				pad[i].nextSibling.nextSibling.style.backgroundColor = color;
				pad[i].nextSibling.nextSibling.nextSibling.nextSibling.style.backgroundColor = color;
			}  
		}
	}
}
